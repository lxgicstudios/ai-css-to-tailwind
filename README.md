...
![npm](https://img.shields.io/npm/v/ai-css-to-tailwind)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-css-to-tailwind)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# CSS to Tailwind CSS conversion and optimization tool

CSS to Tailwind converter. Automatically migrates CSS to utility-first Tailwind classes.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-css-to-tailwind.svg)](https://badge.fury.io/js/ai-css-to-tailwind)
